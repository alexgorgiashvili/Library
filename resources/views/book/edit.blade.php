                ...
                <div class="column">
                    ...
                    <div class="field">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input name="book_status"
                            @if($book->status == 0)
                            checked
                            @endif
                            class="form-check-input cursor-pointer " type="checkbox"  value="0" >
                    ...
                    <div class="buttons control mt-5 mb-3 is-flex is-justify-content-flex-end">
                        <button form='editForm' type='submit' class="button mob-btn is-primary mr-2">Save book</button>
